...
/***/ function(module, exports, __webpack_require__) {
	...
	var ATM = __webpack_require__(169);

	//Render React App to browser
	ReactDOM.render(React.createElement(ATM, null), document.getElementById('atm'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InsertCard = __webpack_require__(174);
	var PIN = __webpack_require__(176);
	var SelectAmount = __webpack_require__(177);
	var Wait = __webpack_require__(178);
	var Money = __webpack_require__(179);
	var Abort = __webpack_require__(180);
	...
	const ATM = React.createClass({
	    ...
	    getCurrentStepIndex: function () {
	        return this.state.steps.map(function (step) {
	            return step.view;
	        }).indexOf(this.state.currentStep.view);
	    },

	    //Gets current step from hash or first one in case no hash is present
	    getCurrentStep: function (steps) {
	        let stepFromHash = $.grep(steps, function (step) {
	            return step.view === window.location.hash.slice(1);
	        });
	    ...
	    render: function () {
	        ...
	        switch (this.state.currentStep.view) {
	            case 'InsertCard':
	                ...
	                break;
	            case 'PIN':
	                view = React.createElement(PIN, { error: this.state.error, PIN: this.state.PIN });
	                break;
	            case 'SelectAmount':
	                view = React.createElement(SelectAmount, { atm: this, error: this.state.error, amount: this.state.amount });
	                break;
	            case 'Wait':
	                view = React.createElement(Wait, null);
	                break;
	            case 'Money':
	                view = React.createElement(Money, { hasCard: this.state.hasCard });
	                break;
	            case 'Abort':
	                view = React.createElement(Abort, { hasCard: this.state.hasCard });
	                break;
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Keypad = __webpack_require__(172);
	var CardSlot = __webpack_require__(173);
	...
	const Actions = React.createClass({
	    ...
	    render: function () {
	        ...
	        if (this.state.step.showKeypad == true) {
	            view = React.createElement(Keypad, { atm: this.props.atm });
	        }

	        if (this.state.step.showCardSlot == true) {
	            view = React.createElement(CardSlot, { atm: this.props.atm });
	        }
	...
	const Keypad = React.createClass({
	    ...
	    render: function () {
	        ...
	        let view = buttons.concat(controlKeys).map(function (text, i) {
	            return React.createElement(
	                'button',
	                { className: !parseInt(text) ? text : '', onClick: this.handleClick, key: i },
	                text
	            );
	        }.bind(this));
...
/***/ function(module, exports, __webpack_require__) {
	...
	const CardSlot = React.createClass({
	    displayName: 'CardSlot',

	    render: function () {
	        return React.createElement(
	            'button',
	            { onClick: this.props.atm.handleCardAction, className: 'card-slot' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var Instruction = __webpack_require__(175);

	const InsertCard = React.createClass({
	    displayName: 'InsertCard',
...
/***/ function(module, exports, __webpack_require__) {
	...
	const Instruction = React.createClass({
	    ...
	    render: function () {
	        return React.createElement(
	            'div',
	            { className: "instruction " + (this.state.error ? 'error' : '') },
	            this.props.children
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	const PIN = React.createClass({
	    ...
	    render: function () {
	        let error = this.state.error ? React.createElement(
	            'span',
	            { className: 'error-msg' },
	            this.state.error
	        ) : false;
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement('input', { type: 'password', readOnly: true, value: this.state.PIN }),
	                error || ''
	            )
	        );
	    }
	    ...
	    render: function () {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement('input', { type: 'number', readOnly: true, value: this.state.amount, name: 'amount' }),
	                React.createElement(
	                    'span',
	                    { className: 'error-msg' },
	                    this.state.error
	    ...
	    render: function () {
	        return React.createElement(
	            ...
	            React.createElement(
	                'h2',
	                null,
	                'Please wait while we prepare your money!'
	            )
	        );
	    }
	});
